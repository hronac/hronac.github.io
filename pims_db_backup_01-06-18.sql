...
INSERT INTO `job` (`job_id`, `user_id`, `other_user`, `pc_id`, `problems`, `solveproc`, `attention`, `status`, `remarks`, `jobcreatedate`, `updatedate`, `jobdoneby`) VALUES (1, '1820', NULL, '177', 'Wifi cant connect', 'then i restart ed sir router', '', 'solve', '', '2018-04-07 09:53:08', '', 'Hasan');
INSERT INTO `job` (`job_id`, `user_id`, `other_user`, `pc_id`, `problems`, `solveproc`, `attention`, `status`, `remarks`, `jobcreatedate`, `updatedate`, `jobdoneby`) VALUES (2, '1819', NULL, '50', 'Office Problem', 'Office reinstall', '', 'solve', '', '2018-04-07 09:52:47', '', 'Hasan');
INSERT INTO `job` (`job_id`, `user_id`, `other_user`, `pc_id`, `problems`, `solveproc`, `attention`, `status`, `remarks`, `jobcreatedate`, `updatedate`, `jobdoneby`) VALUES (3, '1981', NULL, 'SMFAC-0093', 'Windows corrupted', 'Reinstall windows and other soft with AD', NULL, 'solve', 'the printer will be setup afterwards', '2018-04-08 13:35:46', NULL, 'Hasan');
INSERT INTO `job` (`job_id`, `user_id`, `other_user`, `pc_id`, `problems`, `solveproc`, `attention`, `status`, `remarks`, `jobcreatedate`, `updatedate`, `jobdoneby`) VALUES (4, '1856', NULL, NULL, 'Laptop doesn''t start', 'then i restart Laptop', NULL, 'Solve', NULL, '2018-05-05 23:48:33', NULL, 'Hasan');
INSERT INTO `job` (`job_id`, `user_id`, `other_user`, `pc_id`, `problems`, `solveproc`, `attention`, `status`, `remarks`, `jobcreatedate`, `updatedate`, `jobdoneby`) VALUES (5, '1856', NULL, NULL, 'Wifi Problems', 'Wifi Router Restart, but cant connect, then some time stop router and one router MKT-1 reset', NULL, 'Solve', NULL, '2018-05-05 23:48:33', NULL, 'Hasan');
