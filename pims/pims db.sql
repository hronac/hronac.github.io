...
-- 
-- Host: localhost
-- Generation Time: Apr 19, 2018 at 02:42 PM
...
INSERT INTO `user` (`user_id`, `user_name`, `designation`, `section`, `pc_type`, `ip`, `teamviewer`, `status`, `section_id`, `pc_id`) VALUES (1814, 'Zahidul', '', 'Accounts', 'Desktop', '****', '***', 'active', '3', NULL);
INSERT INTO `user` (`user_id`, `user_name`, `designation`, `section`, `pc_type`, `ip`, `teamviewer`, `status`, `section_id`, `pc_id`) VALUES (1815, 'Samad(ACC)', '', 'Accounts', 'Desktop', '****', '***', 'active', '3', NULL);
INSERT INTO `user` (`user_id`, `user_name`, `designation`, `section`, `pc_type`, `ip`, `teamviewer`, `status`, `section_id`, `pc_id`) VALUES (1816, 'Nasir Uddin', '', 'Accounts', 'Desktop', '****', '***', 'active', '3', NULL);
INSERT INTO `user` (`user_id`, `user_name`, `designation`, `section`, `pc_type`, `ip`, `teamviewer`, `status`, `section_id`, `pc_id`) VALUES (1817, 'Production Audit-2', '', 'Accounts', 'Desktop', '****', '***', 'active', '3', NULL);
INSERT INTO `user` (`user_id`, `user_name`, `designation`, `section`, `pc_type`, `ip`, `teamviewer`, `status`, `section_id`, `pc_id`) VALUES (1818, 'Humayun', '', 'Accounts', 'Desktop', '****', '***', 'active', '3', NULL);
INSERT INTO `user` (`user_id`, `user_name`, `designation`, `section`, `pc_type`, `ip`, `teamviewer`, `status`, `section_id`, `pc_id`) VALUES (1819, 'Production Audit-1', '', 'Accounts', 'Desktop', '****', '***', 'active', '3', NULL);
INSERT INTO `user` (`user_id`, `user_name`, `designation`, `section`, `pc_type`, `ip`, `teamviewer`, `status`, `section_id`, `pc_id`) VALUES (1820, 'IMRUL', 'AGM Accounts & Store', 'Accounts', 'Laptop', '****', '***', 'active', '3', NULL);
...
INSERT INTO `user` (`user_id`, `user_name`, `designation`, `section`, `pc_type`, `ip`, `teamviewer`, `status`, `section_id`, `pc_id`) VALUES (1823, 'MD Sir', '', 'Admin', 'Desktop', '****', '***', 'active', '2', NULL);
INSERT INTO `user` (`user_id`, `user_name`, `designation`, `section`, `pc_type`, `ip`, `teamviewer`, `status`, `section_id`, `pc_id`) VALUES (1824, 'Anwar', '', 'Admin', 'Desktop', '****', '***', 'active', '2', NULL);
